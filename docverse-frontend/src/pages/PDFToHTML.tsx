  ...
  const handleProcess = async () => {
    ...
    try {
      await new Promise<void>((resolve, reject) => {
        ...
        xhr.open("POST", `${apiBase}/convert/pdf-to-html`);
      ...
      setError("Something went wrong while converting your PDF to HTML. Please try again.");
    } finally {
        ...
        {!isComplete ? (
          isProcessing ? (
            <div ref={loadingRef} className="py-16 flex flex-col items-center gap-6">
              <h2 className="text-2xl font-semibold">Converting to HTML...</h2>
            ...
            <div className="flex flex-col items-center gap-4">
              <Button
                ...
                onClick={() => {
                  ...
                  link.download = `${baseName}-html.zip`;
